...
public:
	...
	GUIButton(const iPoint & position, const SDL_Rect & bounds, const char * text = nullptr, const SDL_Rect * out_section = nullptr, const SDL_Rect * in_section = nullptr, const SDL_Rect * click_section = nullptr, uint clickSFX = 0u);
